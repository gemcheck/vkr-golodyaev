...
Данное исследование проводится в рамках подготовки выпускной квалификационной работы (ВКР) и направлено на изучение влияния различных способов визуализации программного кода на языке программирования Python3 на скорость его понимания и качество запоминания информации.
