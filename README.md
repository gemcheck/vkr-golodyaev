...
5. **Запустите проект**
   ...
   При певром запуске необходимо обязательно запустить проект, чтобы созадлись все необходимые папки и файлыю
...
Для корректного стягивания **Веб-платформы** пользуйтесь файлом `deploy.sh`. Линукс имеет свойсто перезатирать прафа на файлы. Также при изменении файлы БД **обязательно** настройке права.
